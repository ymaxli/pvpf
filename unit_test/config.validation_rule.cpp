...
//    }
    ...
    BOOST_AUTO_TEST_CASE(rule_mapping_pass)
    {
        const char* json = "{\n"
                           "    \"meta\": {\n"
                           "        \"name\": \"pvp-project-1\",\n"
        ...
        Document d;
        d.Parse(json);
        validation_result res = concrete_rule_mapping_check(d);

        BOOST_CHECK_EQUAL(res.get_type(), 0);
        BOOST_CHECK_EQUAL(res.get_message(), "Pass: mapping field check");
    }


    BOOST_AUTO_TEST_CASE(rule_mapping_graph_input_mapping_not_object)
    {
        const char* json = "{\n"
                           "    \"source\": [\n"
                           "        {\n"
        ...
        BOOST_CHECK_EQUAL(res.get_type(), 2);
        BOOST_CHECK_EQUAL(res.get_message(), "Error: mapping field should be an object \"node-1\"");
    }

    BOOST_AUTO_TEST_CASE(rule_mapping_graph_input_value_not_string)
    {
        const char* json = "{\n"
                           "    \"source\": [\n"
                           "        {\n"
        ...
        BOOST_CHECK_EQUAL(res.get_type(), 2);
        BOOST_CHECK_EQUAL(res.get_message(), "Error: values in mapping field should be string \"node-1\"");
    }

    BOOST_AUTO_TEST_CASE(rule_mapping_graph_output_value_not_string)
    {
        const char* json = "{\n"
                           "    \"source\": [\n"
                           "        {\n"
    ...
    BOOST_AUTO_TEST_CASE(rule_mapping_graph_input_value_no_dot)
    {
        const char* json = "{\n"
                           "    \"source\": [\n"
                           "        {\n"
        ...
        BOOST_CHECK_EQUAL(res.get_type(), 2);
        BOOST_CHECK_EQUAL(res.get_message(), "Error: mapping wrong format \"node-1\"");
    }

    BOOST_AUTO_TEST_CASE(rule_mapping_graph_input_value_not_digit)
    {
        const char* json = "{\n"
                       "    \"source\": [\n"
                       "        {\n"
    ...
    BOOST_AUTO_TEST_CASE(rule_mapping_graph_input_value_unfit)
    {
        const char* json = "{\n"
                   "    \"source\": [\n"
                   "        {\n"
        ...
        BOOST_CHECK_EQUAL(res.get_type(), 2);
        BOOST_CHECK_EQUAL(res.get_message(), "Error: mapping key unfit \"node-1\"");
    }

    BOOST_AUTO_TEST_CASE(rule_mapping_graph_array_input_value_unfit)
    {
        const char* json = "{\n"
                   "    \"source\": [\n"
                   "        {\n"
    ...
    BOOST_AUTO_TEST_CASE(rule_mapping_graph_array_input_value_not_string)
    {
        const char* json = "{\n"
                           "    \"source\": [\n"
                           "        {\n"
    ...
    BOOST_AUTO_TEST_CASE(rule_mapping_graph_array_input_value_no_dot)
    {
        const char* json = "{\n"
                           "    \"source\": [\n"
                           "        {\n"
    ...
    BOOST_AUTO_TEST_CASE(rule_mapping_graph_array_input_value_not_digit)
    {
        const char* json = "{\n"
                       "    \"source\": [\n"
                       "        {\n"
    ...
    BOOST_AUTO_TEST_CASE(rule_mapping_sink_input_value_not_string)
    {
        const char* json = "{\n"
                           "    \"source\": [\n"
                           "        {\n"
        ...
        BOOST_CHECK_EQUAL(res.get_type(), 2);
        BOOST_CHECK_EQUAL(res.get_message(), "Error: values in mapping field should be string \"sink-1\"");
    }


    BOOST_AUTO_TEST_CASE(rule_mapping_sink_input_value_no_dot)
    {
        const char* json = "{\n"
                           "    \"source\": [\n"
                           "        {\n"
        ...
        BOOST_CHECK_EQUAL(res.get_type(), 2);
        BOOST_CHECK_EQUAL(res.get_message(), "Error: mapping wrong format \"sink-1\"");
    }

    BOOST_AUTO_TEST_CASE(rule_mapping_sink_input_value_not_digit)
    {
        const char* json = "{\n"
                       "    \"source\": [\n"
                       "        {\n"
    ...
    BOOST_AUTO_TEST_CASE(rule_mapping_sink_input_value_unfit)
    {
        const char* json = "{\n"
                   "    \"source\": [\n"
                   "        {\n"
        ...
        BOOST_CHECK_EQUAL(res.get_type(), 2);
        BOOST_CHECK_EQUAL(res.get_message(), "Error: mapping key unfit \"sink-1\"");
    }

    BOOST_AUTO_TEST_CASE(rule_mapping_sink_array_input_value_unfit)
    {
        const char* json = "{\n"
                   "    \"source\": [\n"
                   "        {\n"
    ...
    BOOST_AUTO_TEST_CASE(rule_mapping_sink_array_input_value_not_string)
    {
        const char* json = "{\n"
                           "    \"source\": [\n"
                           "        {\n"
    ...
    BOOST_AUTO_TEST_CASE(rule_mapping_sink_array_input_value_no_dot)
    {
        const char* json = "{\n"
                           "    \"source\": [\n"
                           "        {\n"
    ...
    BOOST_AUTO_TEST_CASE(rule_mapping_sink_array_input_value_not_digit)
    {
        const char* json = "{\n"
                       "    \"source\": [\n"
                       "        {\n"
